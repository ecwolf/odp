...
/* The length(bit) of the IPv6 address */
...
odph_table_t
odph_iplookupv6_table_lookup(const char *name)
{
					...
					uint32_t value_size)
{
	...
	tbl = (void *)odph_iplookupv6_table_lookup(name);
	if (tbl != NULL) {
...
int
odph_iplookupv6_table_destroy(odph_table_t tbl)
{
	int i, j;
...
int odph_iplookupv6_table_get_value(odph_table_t tbl, void *key,
...
odph_table_ops_t odph_iplookupv6_table_ops = {
	odph_iplookupv6_table_create,
	odph_iplookupv6_table_lookup,
	odph_iplookupv6_table_destroy,
	odph_iplookupv6_table_put_value,
	odph_iplookupv6_table_get_value,
	odph_iplookupv6_table_remove_value
};
